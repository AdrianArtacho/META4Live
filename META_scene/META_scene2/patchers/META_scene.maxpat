...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 436.0, 69.0, 22.0 ],
					"text" : "print trigger"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 388.0, 75.0, 22.0 ],
					"text" : "print LEXER"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 538.0, 40.0, 82.0, 22.0 ],
					"text" : "loadmess 113"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 538.0, 7.0, 83.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 538.0, 71.0, 65.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 551.0, 198.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 112.0, 5.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 531.0, 233.0, 97.0, 35.0 ],
					"text" : ";\rmax maxwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 352.0, 75.0, 22.0 ],
					"text" : "print GETET"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 505.0, 120.0, 52.0, 22.0 ],
					"text" : "CCinput"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 307.75, 112.0, 70.0, 22.0 ],
					"text" : "r ---controls"
				}
...
,
					"patching_rect" : [ 268.75, 276.5, 97.0, 22.0 ],
...
,
					"patching_rect" : [ 166.25, 204.0, 127.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 45.0, 215.0, 147.0, 403.0 ],
									"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 30.0, 157.25, 48.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 346.75, 241.5, 72.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 307.75, 145.0, 79.0, 86.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 46.0, 104.0, 69.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_defer" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 57.5, 87.5, 514.5, 87.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 175.75, 235.75, 278.25, 235.75 ],
					"order" : 1,
					"source" : [ "obj-8", 0 ]
				}
